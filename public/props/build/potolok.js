...
function potolok(x, y, z) {
    const loader = new THREE.TextureLoader();
    // Создание пола
    const floorTexture = loader.load('img/potolok.png');

    const floorGeometry = new THREE.BoxGeometry(4, 4, 0.3);
    var normalMap = THREE.ImageUtils.loadTexture ('img/potolok_normal.png');
    const floorMaterial = new THREE.MeshPhongMaterial({map: floorTexture, normalMap: normalMap, shininess: 10});
